...
describe("formatMediaUri", () => {
    ...
    test("blob ref builds cdn url", () => {
        ...
        expect(formatMediaUri(blob, { authorDid: "did:plc:author" })).toBe(
            "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:author/bafyref@png",
        );
    });
    ...
    test("thumbnail preview uses feed_thumbnail path (cover-style preview)", () => {
        ...
        expect(thumb).toBe("https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:author/bafyref@png");
        expect(full).toBe("https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:author/bafyref@png");
    });
});
...
describe("formatMediaUris", () => {
    test("returns default thumbnail and fullsize urls", () => {
        ...
        expect(formatMediaUris(blob, { authorDid: "did:plc:author" })).toEqual({
            thumbnail: {
                png: "https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:author/bafyref@png",
                webp: "https://cdn.bsky.app/img/feed_thumbnail/plain/did:plc:author/bafyref@webp",
            },
            fullsize: {
                png: "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:author/bafyref@png",
                webp: "https://cdn.bsky.app/img/feed_fullsize/plain/did:plc:author/bafyref@webp",
            },
        });
    });
